...
<?php
    if($this->request->params['controller'] == 'years')
...
<?php
    if($this->request->params['controller'] == 'periods')
        echo '<li class="active">';
    else
        echo '<li class="tab2">';
    ?>
    ...
    <?php
    if($this->request->params['controller'] == 'cycles')
        echo '<li class="active">';
    else
        echo '<li class="tab2">';
    ?>
    ...
    <?php
    if($this->request->params['controller'] == 'levels')
        echo '<li class="active">';
    else
        echo '<li class="tab3">';
