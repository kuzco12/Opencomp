<div class="page-title">
    ...
    <div class="btn-toolbar">
		...
		<?php echo $this->Html->link('<i class="icon-arrow-left"></i> '.__('retour à l\'évaluation'), '/evaluations/attacheditems/'.$eval['Evaluation']['id'], array('class' => 'ontitle btn', 'escape' => false)); ?>
	</div>
</div>
