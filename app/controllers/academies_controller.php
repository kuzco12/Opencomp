...
class AcademiesController extends AppController
{
        ...
        if (!empty($this->data)) {
            ...
            if ($this->Academy->save($this->data)) {
                $this->Session->setFlash(
                    __('L\'académie a été ajoutée.', true),
                    'message_succes'
                );
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(
                    __('L\'académie n\'a pas pu être ajoutée.', true),
                    'message_erreur'
                );
            }
        }
    ...
    function edit($id = null)
    {
        ...
        if (!empty($this->data)) {
            if ($this->Academy->save($this->data)) {
                $this->Session->setFlash(
                    __('L\'académie a été sauvegardé.', true), 
                    'message_succes'
                );
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(
                    __('L\'académie n\'a pas pu être éditée.', true), 
                    'message_erreur'
                );
            }
        }
        ...
        if (empty($this->data)) {
            ...
            if (empty($this->data)) {
                $this->Session->setFlash(
                    __(
                        'L\'académie que vous souhaitez éditer n\'existe pas.', 
                        true
                    ),
                    'message_erreur'
                );
    ...
    function delete($id)
    {
        ...
        if ($this->Academy->delete($id)) {
            $this->Session->setFlash(
                __('L\'académie a été supprimée.', true),
                'message_succes'
            );
            $this->redirect(array('action'=>'index'));
        }
        ...
        $this->Session->setFlash(
            __('L\'académie que vous souhaitez supprimer n\'existe pas.', true),
            'message_erreur'
        );
        $this->redirect(array('action' => 'index'));
    }
    ...
    function view($id)
    {
        ...
        if (!empty($infoAcademy)) {
            ...
            $this->Session->setFlash(
                __('L\'académie que vous souhaitez afficher n\'existe pas.', true), 
                'message_erreur'
            );
            $this->redirect(array('action' => 'index'));
        }
