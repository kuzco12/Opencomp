...
<div class="periods index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $time->format("d/m/Y",$period['Period']['begin']).' à '.$time->format("d/m/Y",$period['Period']['end']);?>&nbsp;</td>
