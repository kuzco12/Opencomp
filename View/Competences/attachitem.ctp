<div class="page-title">
    <h2><?php echo __('Associer un item à une évaluation'); ?></h2>
		...
		<?php echo $this->Html->link('<i class="icon-arrow-left"></i> '.__('retour à l\'évaluation'), '/evaluations/attacheditems/'.$eval['Evaluation']['id'], array('class' => 'ontitle btn btn-default', 'escape' => false)); ?>
</div>
